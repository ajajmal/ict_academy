#To accept a string value from the user and display the count of each character in that string
...
The maximum of three numbers is:24.0
"""
...
#program which iterates from 1 to 10. For multiples of 2,
...
#Python program to find the most frequent item in a list of numbers
...
#program to find the sum of squares of the numbers in a list
...
#program using for loop that will iterate from 1 to 15. Foreach iteration,
